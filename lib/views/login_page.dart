...
import 'package:solaria_dev/views/home_page.dart';
import 'package:solaria_dev/widgets/dialogs.dart';
  ...
  doLogin(email, password) async {
    ...
    try {
      final response = await http.post(
          Uri.parse("https://10.10.2.198/solaria/public/api/auth/login"),
